    ...
    return (
        ...
        >
            ...
            <ScrollView contentContainerStyle={styles.content} contentInsetAdjustmentBehavior="automatic">
                <Text style={styles.heading}>Register for {event.name}</Text>

                <View style={[styles.section, styles.transparent]}>
                    ...
                    {event.classes?.map((cls: any) => (
                        ...
                        >
                            <View style={[styles.classHeader, styles.transparent]}>
                            ...
                            {selectedClassId === cls.id && (
                                <View style={[styles.checkIcon, styles.transparent]}>
                ...
                <View style={[styles.section, styles.transparent]}>
                    <Text style={styles.sectionTitle}>2. Driver Information</Text>
                ...
                <View style={[styles.footer, styles.transparent]}>
                    <Button
